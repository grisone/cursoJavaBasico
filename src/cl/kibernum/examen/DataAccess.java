...
import cl.kibernum.db.MySQLHelper;
...
public class DataAccess {
    ...
    public void insert(int id, String name, String gender, int age) throws SQLException{
        PreparedStatement preparedStatement = getConexion().prepareStatement(UPDATE_QUERY);
        preparedStatement.setInt( 4, id );
        preparedStatement.setString( 1, name);
        preparedStatement.setString( 2,   gender );
    ...
    public static void main(String args[]){
        cl.kibernum.db.Test test = new cl.kibernum.db.Test();
